...
compDia:
	...
	je		diaValido					;Si es valido el dia sigo con la semana
...
sumarAct:
	...
	sub		byte[semana],1
	mov		al,byte[semana]
	mov		bl,14			;muevo al bl 14 como multiplicador (cant.cols x long.elem = 14)
...
ingresoSemana:
	...
	;ya tengo el nro ingresado [1..6] en binario (double word 4 bytes) nroIng
