...
calcDesplaz:
    ...
    mov bx,[fila]
    sub bx,1; dec bx
    imul bx,bx,10 ;(fila - 1 ) * (long elemento(2)*cant columnas(5))

    mov [desplaz],bx

    mov bx,[columna]
    sub bx,1
    imul bx,bx,2 ;(columna - 1)* long elemento (2)
...
calcSumatoria:
    ...
    mov cx,6
    sub cx,[columna] ;seteo el rcx en la cant de repeticiones = 6 - columna ingresada
